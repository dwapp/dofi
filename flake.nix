        ...
        in
        {
          ...
          devShells.default = pkgs.mkShell {
            ...
            in ''
              ...
              export QT_PLUGIN_PATH=${makeQtpluginPath (with pkgs.kdePackages; [ qtbase qtdeclarative qtquick3d qtwayland layer-shell-qt ])}
              export QML2_IMPORT_PATH=${makeQmlpluginPath (with pkgs.kdePackages; [ qtdeclarative qtquick3d layer-shell-qt ])}
